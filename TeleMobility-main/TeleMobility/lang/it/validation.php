    ...
    */
    ...
    'custom' => [
        ...
        'Genere' => [
                ...
                'in'=> 'Il genere deve essere M oppure F', 
        ],
        'name' => ['required' => "Il nome è obbligatorio",
            ],
        'surname' => ['required' => "Il cognome è obbligatorio",
        ],
        'DataDiNascita' => ['required' => "La data di nascita è obbligatoria",
                             'date_format' => "La data di nascita deve essere nel formato YYYY-mm-dd"
                            ],
        
        'Telefono' => ['required' => "Il numero di telefono è obbligatorio",
                        'size'=> "Il numero di telefono deve essere di :size cifre"
    ],
    ...
    'password_n' => [
        ...
        'min' => 'La nuova password deve essere lunga almeno :min caratteri.',
        'confirmed' => 'I campi della nuova password non corrispondono',
    ],
    ...
    'Descrizione' => [
        'required' => 'La descrizione del clinico è obbligatoria',
    ],
    'Specializzazione' => [
        'required' => 'La specializzazione del clincio è obbligatoria',
    ],
    'Ruolo' => [ 
        'required' => 'Il ruolo del clinico è obbligatorio',
        'in' => 'Il ruolo del clinico può essere Medico o Fisioterapista'
    ] ,
    'Orario' => [ 
        'required' => 'L inserimento dell orario è obbligatorio',
    ],
    'ID_Disturbo' => [ 
        'required' => 'L inserimento del tipo di disturbo è obbligatorio',
    ],
    'Data_Evento' => [ 
        'required' => 'L inserimento della data è obbligatorio',
    ],
    'Durata' => [ 
        'required' => 'L inserimento della durata è obbligatorio',
    ],
    'Intensita' => [ 
        'required' => 'L inserimento dell intensità dell evento è obbligatorio',
    ],
    'Domanda' => [
        'required' =>'La domanda è obbligatoria',
    ],
    'Risposta' => ['required' => 'La risposta è obbligatoria',],
    'id_destinatario' => ['required' => 'Inserisci almeno un destinatario',],
    'corpo' => ['required' => 'Il titolo del messaggio è obbligatorio',],
    'contenuto' => ['required' => 'Il contenuto del messaggio è obbligatorio',]
