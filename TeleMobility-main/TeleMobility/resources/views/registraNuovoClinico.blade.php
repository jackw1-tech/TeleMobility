...
<div class="container">
    ...
    {{ html()->form('POST', route('clinico.store'))->acceptsFiles()->open() }}
        ...
        <div style="background-color: #0000; display: flex ; padding-top: 1%;" >
            ...
            <div style="width: 30%;" >
            {{ html()->text('Specializzazione')->id('current')}}
        ...
        <div style="background-color: #0000; display: flex ; padding-top: 1%;" >
            ...
            <div style="width: 30%;" >
            {{ html()->textArea('Descrizione')->id('current')}}
    ...
    <div style="margin-top:0.5%">
        <button onclick="window.location.href='{{route('GestioneClinico')}}'" class="bottoneCartella1"> Indietro </button>
    </div>
